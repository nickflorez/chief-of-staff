          ...
          <article className="relative">
            ...
            <div className="md:pl-12 relative">
              ...
              <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 mb-4">Image Support</h2>

                <p className="text-gray-600 mb-6">
                  You can now share screenshots and images with your assistant! Simply paste an image from your clipboard or take a screenshot and paste it directly into the chat.
                </p>
                  ...
                  <div>
                    ...
                    <ul className="grid md:grid-cols-2 gap-2">
                      {[
                        ...
                        "Support for PNG, JPEG, GIF, and WebP images",
